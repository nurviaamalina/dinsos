...
class Statistik extends BaseController
{
    ...
    public function index()
    {
        ...
        /*
         * Normalisasi object menjadi array.
         */
        ...
        foreach ($semuaLayanan as $item) {
            ...
            /*
             * Proses tidak boleh lebih besar
             * dari sisa setelah selesai.
             */
            ...
            /*
             * Normalisasi bidang agar case tidak
             * membuat bidang terpisah.
             */

            $bidang =
                $this->normalizeBidang(
                    $bidangAsli
                );
         ...
         * DEFINISI:
         *
         * Top 4 berdasarkan jumlah permohonan SELESAI
         * terbanyak.
         */
         ...
         *
         * 1. Selesai terbanyak
         * 2. Jika sama, jumlah permohonan terbanyak
         */
         ...
         * =========================================================
         *
         * Tetap berdasarkan capaian tertinggi.
         */
         ...
         * Ranking kecamatan:
         * 1. Capaian tertinggi
         * 2. Jika sama, jumlah selesai terbanyak
         */
         ...
         * =========================================================
         *
         * Bagian ini dipertahankan sesuai logic
         * yang sudah berhasil pada sisi Admin.
         */
    ...
    if (
        ...
        return view(
            'Dashboard_statistik/dashboard_statistik',
            $data
        );
    }
