...
class Layanan extends BaseController
{
       ...
       public function store()
    {
        ...
        $this->layananModel->save([
            ...
            'sistem_mekanisme_prosedur' => $this->request->getPost('sistem_mekanisme_prosedur'),
            'jangka_waktu_pelayanan' => $this->request->getPost('jangka_waktu_pelayanan'),
            'biaya_tarif' => $this->request->getPost('biaya_tarif'),
            'produk_pelayanan' => $this->request->getPost('produk_pelayanan'),
            'penanganan_pengaduan' => $this->request->getPost('penanganan_pengaduan'),
            'sarana_prasarana_fasilitas' => $this->request->getPost('sarana_prasarana_fasilitas'),
            'kompetensi_pelaksana' => $this->request->getPost('kompetensi_pelaksana'),
            'pengawasan_internal' => $this->request->getPost('pengawasan_internal'),
            'jumlah_pelaksana' => $this->request->getPost('jumlah_pelaksana'),
            'jaminan_pelayanan' => $this->request->getPost('jaminan_pelayanan'),
            'jaminan_keamanan_keselamatan' => $this->request->getPost('jaminan_keamanan_keselamatan'),
            'evaluasi_kinerja_pelaksana' => $this->request->getPost('evaluasi_kinerja_pelaksana'),
