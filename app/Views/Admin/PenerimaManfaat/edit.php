...
<div class="d-flex">
    ...
    <div class="content flex-grow-1 penerima-page">
        ...
        <div class="penerima-form-card">
            ...
            <!-- FORM -->
            <form
                action="<?= base_url('admin/penerima-manfaat/update/' . $penerima['id']) ?>"
                method="post"
            >
                        ...
                        >
                            ...
                            <option
                                ...
                                <?= old(
                                    'kategori',
                                    $penerima['kategori'] ?? ''
                                ) === 'Penyandang Disabilitas' ? 'selected' : '' ?>
                            >
                            ...
                            <option
                                ...
                                <?= old(
                                    'kategori',
                                    $penerima['kategori'] ?? ''
                                ) === 'Keluarga Penerima Manfaat' ? 'selected' : '' ?>
                            >
